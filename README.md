...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pari_jupyter-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pari_jupyter-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pari_jupyter
# for installing globally
pixi global install pari_jupyter
```
...
It is possible to list all of the versions of `pari_jupyter` available on your platform:
...
```
pixi search pari_jupyter --channel conda-forge
```
